...
## 📊 Статистика строк кода (только мои репозитории)

| Язык | Строк кода | Доля |
|------|-----------:|-----:|
| PHP | 5,851 | 57.1% |
| JavaScript | 1,895 | 18.5% |
| CSS | 1,627 | 15.9% |
| HTML | 697 | 6.8% |
| Python | 169 | 1.7% |

**Всего строк кода:** 10,239

*Обновлено: 18.04.2025 17:29*

*Примечание: анализируются только репозитории, где я являюсь автором, исключены форки и служебные файлы*